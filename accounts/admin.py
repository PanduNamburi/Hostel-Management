...
class UserAdmin(BaseUserAdmin):
    list_display = ('username', 'email', 'role', 'is_active', 'is_approved', 'is_staff', 'is_superuser')
    ...
    fieldsets = (
        ...
        ('Permissions', {'fields': ('is_active', 'is_approved', 'is_staff', 'is_superuser', 'groups', 'user_permissions', 'role')}),
